...
Program berbasis Python untuk menghasilkan gambar kerja teknik secara otomatis dalam format AutoCAD (DXF) dan model 3D (STL). 
Alat ini dirancang untuk mempermudah desainer dan arsitek dalam membuat visualisasi cepat furnitur (kursi) dan denah ruangan berdasarkan input dimensi mentah. 
